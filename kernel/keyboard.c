...
int irq_keyboard_state;
unsigned short scancode;
unsigned char e0_e1,sysrq;
int led_state;
...
inline int get_num_state(void){return num_lock;}
inline int get_caps_state(void){return caps_lock;}
inline int get_scroll_state(void){return scroll_lock;}
